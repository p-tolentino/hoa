          ...
          <Box borderWidth="1px" p={10} borderRadius="md" w="60vw">
            <Stack spacing={5} fontFamily="font.body" fontSize="md">
              ...
              <Text textAlign="justify">
                ...
                attention, and the corresponding fee must be settled.{" "}
                {/* within{" "}
                <span className="font-semibold">
              ...
              <Text textAlign="justify">
                ...
                <span className="font-semibold">statement of account</span> for
                the necessary details, including the payment amount, due date,
                and acceptable payment methods. If you have any questions or
                concerns regarding the violation or the associated fee, please
